...
/**
 * TournamentV4TournamentCodeUpdateParameters Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TournamentV4TournamentCodeUpdateParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tournament-v4.TournamentCodeUpdateParameters';
     ...
     * Sets map_type
     *
     * @param string $map_type The map type              (Legal values:  SUMMONERS_RIFT,  TWISTED_TREELINE,  HOWLING_ABYSS)
     *
     * @return $this
     */
