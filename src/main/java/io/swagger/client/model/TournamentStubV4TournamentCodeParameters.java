...
public class TournamentStubV4TournamentCodeParameters {
  /**
  ...
  public TournamentStubV4TournamentCodeParameters spectatorType(SpectatorTypeEnum spectatorType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The spectator type of the game.              (Legal values:  NONE,  LOBBYONLY,  ALL)")
  ...
  public TournamentStubV4TournamentCodeParameters teamSize(Integer teamSize) {
   ...
   * @return teamSize
  **/
  @ApiModelProperty(required = true, value = "The team size of the game. Valid values are 1-5.")
  ...
  public TournamentStubV4TournamentCodeParameters pickType(PickTypeEnum pickType) {
   ...
   * @return pickType
  **/
  @ApiModelProperty(required = true, value = "The pick type of the game.              (Legal values:  BLIND_PICK,  DRAFT_MODE,  ALL_RANDOM,  TOURNAMENT_DRAFT)")
  ...
  public TournamentStubV4TournamentCodeParameters allowedSummonerIds(List<String> allowedSummonerIds) {
    this.allowedSummonerIds = allowedSummonerIds;
    return this;
  }

  public TournamentStubV4TournamentCodeParameters addAllowedSummonerIdsItem(String allowedSummonerIdsItem) {
  ...
  **/
  ...
  public TournamentStubV4TournamentCodeParameters mapType(MapTypeEnum mapType) {
   ...
   * @return mapType
  **/
  @ApiModelProperty(required = true, value = "The map type of the game.              (Legal values:  SUMMONERS_RIFT,  TWISTED_TREELINE,  HOWLING_ABYSS)")
  ...
  public TournamentStubV4TournamentCodeParameters metadata(String metadata) {
   ...
   * @return metadata
  **/
  @ApiModelProperty(value = "Optional string that may contain any data in any format, if specified at all. Used to denote any custom information about the game.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TournamentStubV4TournamentCodeParameters tournamentStubV4TournamentCodeParameters = (TournamentStubV4TournamentCodeParameters) o;
    return Objects.equals(this.spectatorType, tournamentStubV4TournamentCodeParameters.spectatorType) &&
        Objects.equals(this.teamSize, tournamentStubV4TournamentCodeParameters.teamSize) &&
        Objects.equals(this.pickType, tournamentStubV4TournamentCodeParameters.pickType) &&
        Objects.equals(this.allowedSummonerIds, tournamentStubV4TournamentCodeParameters.allowedSummonerIds) &&
        Objects.equals(this.mapType, tournamentStubV4TournamentCodeParameters.mapType) &&
        Objects.equals(this.metadata, tournamentStubV4TournamentCodeParameters.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(spectatorType, teamSize, pickType, allowedSummonerIds, mapType, metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class TournamentStubV4TournamentCodeParameters {\n");
