 ...
 */
data class TournamentMinusstubMinusv4TournamentCodeParameters (
    /* The spectator type of the game.              (Legal values:  NONE,  LOBBYONLY,  ALL) */
    val spectatorType: TournamentMinusstubMinusv4TournamentCodeParameters.SpectatorType,
    /* The team size of the game. Valid values are 1-5. */
    val teamSize: kotlin.Int,
    /* The pick type of the game.              (Legal values:  BLIND_PICK,  DRAFT_MODE,  ALL_RANDOM,  TOURNAMENT_DRAFT) */
    val pickType: TournamentMinusstubMinusv4TournamentCodeParameters.PickType,
    /* The map type of the game.              (Legal values:  SUMMONERS_RIFT,  TWISTED_TREELINE,  HOWLING_ABYSS) */
    val mapType: TournamentMinusstubMinusv4TournamentCodeParameters.MapType,
