...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SpectatorV4BannedChampion', 'model/SpectatorV4Observer', 'model/SpectatorV4Participant'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SpectatorV4BannedChampion'), require('./SpectatorV4Observer'), require('./SpectatorV4Participant'));
  } else {
    // Browser globals (root is window)
    if (!root.RiotApi) {
      root.RiotApi = {};
    }
    root.RiotApi.SpectatorV4FeaturedGameInfo = factory(root.RiotApi.ApiClient, root.RiotApi.SpectatorV4BannedChampion, root.RiotApi.SpectatorV4Observer, root.RiotApi.SpectatorV4Participant);
  }
}(this, function(ApiClient, SpectatorV4BannedChampion, SpectatorV4Observer, SpectatorV4Participant) {
  'use strict';
  ...
  /**
   * The SpectatorV4FeaturedGameInfo model module.
   * @module model/SpectatorV4FeaturedGameInfo
   * @version dfa1c0f97b9cc62a43c9fb91daa1b91b3e9485c2
   */

  /**
   * Constructs a new <code>SpectatorV4FeaturedGameInfo</code>.
   * @alias module:model/SpectatorV4FeaturedGameInfo
   * @class
   */
  ...
  /**
   * Constructs a <code>SpectatorV4FeaturedGameInfo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SpectatorV4FeaturedGameInfo} obj Optional instance to populate.
   * @return {module:model/SpectatorV4FeaturedGameInfo} The populated <code>SpectatorV4FeaturedGameInfo</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('participants')) {
        obj['participants'] = ApiClient.convertToType(data['participants'], [SpectatorV4Participant]);
      }
   ...
   * @member {module:model/SpectatorV4FeaturedGameInfo.GameModeEnum} gameMode
   */
   ...
   * @member {module:model/SpectatorV4FeaturedGameInfo.GameTypeEnum} gameType
   */
   ...
   * @member {Array.<module:model/SpectatorV4Participant>} participants
   */
  ...
  /**
   * Allowed values for the <code>gameType</code> property.
   * @enum {String}
   * @readonly
   */
  exports.GameTypeEnum = {
    /**
     * value: "CUSTOM_GAME"
     * @const
     */
