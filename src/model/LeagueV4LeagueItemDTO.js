...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RiotApi.LeagueV4LeagueItemDTO = factory(root.RiotApi.ApiClient, root.RiotApi.LeagueV4MiniSeriesDTO);
  }
  ...
  /**
   * The LeagueV4LeagueItemDTO model module.
   * @module model/LeagueV4LeagueItemDTO
   * @version dfa1c0f97b9cc62a43c9fb91daa1b91b3e9485c2
   */

  /**
   * Constructs a new <code>LeagueV4LeagueItemDTO</code>.
   * @alias module:model/LeagueV4LeagueItemDTO
   * @class
   */
  ...
  /**
   * Constructs a <code>LeagueV4LeagueItemDTO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LeagueV4LeagueItemDTO} obj Optional instance to populate.
   * @return {module:model/LeagueV4LeagueItemDTO} The populated <code>LeagueV4LeagueItemDTO</code> instance.
   */
