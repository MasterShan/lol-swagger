...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RiotApi.MatchV4MatchReferenceDto();
  });
  ...
  describe('MatchV4MatchReferenceDto', function() {
    it('should create an instance of MatchV4MatchReferenceDto', function() {
      // uncomment below and update the code to test MatchV4MatchReferenceDto
      //var instance = new RiotApi.MatchV4MatchReferenceDto();
      //expect(instance).to.be.a(RiotApi.MatchV4MatchReferenceDto);
    });
