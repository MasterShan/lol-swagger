...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RiotApi.LolStatusV3Message();
  });
  ...
  describe('LolStatusV3Message', function() {
    it('should create an instance of LolStatusV3Message', function() {
      // uncomment below and update the code to test LolStatusV3Message
      //var instance = new RiotApi.LolStatusV3Message();
      //expect(instance).to.be.a(RiotApi.LolStatusV3Message);
    });
