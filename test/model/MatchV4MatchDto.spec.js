...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RiotApi.MatchV4MatchDto();
  });
  ...
  describe('MatchV4MatchDto', function() {
    it('should create an instance of MatchV4MatchDto', function() {
      // uncomment below and update the code to test MatchV4MatchDto
      //var instance = new RiotApi.MatchV4MatchDto();
      //expect(instance).to.be.a(RiotApi.MatchV4MatchDto);
    });
    ...
    it('should have the property participantIdentities (base name: "participantIdentities")', function() {
      // uncomment below and update the code to test the property participantIdentities
      //var instance = new RiotApi.MatchV4MatchDto();
      //expect(instance).to.be();
    });
    ...
    it('should have the property gameDuration (base name: "gameDuration")', function() {
      // uncomment below and update the code to test the property gameDuration
      //var instance = new RiotApi.MatchV4MatchDto();
      //expect(instance).to.be();
    });

    it('should have the property gameCreation (base name: "gameCreation")', function() {
      // uncomment below and update the code to test the property gameCreation
      //var instance = new RiotApi.MatchV4MatchDto();
      //expect(instance).to.be();
    });
