...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RiotApi.LeagueV4LeagueEntryDTO();
  });
  ...
  describe('LeagueV4LeagueEntryDTO', function() {
    it('should create an instance of LeagueV4LeagueEntryDTO', function() {
      // uncomment below and update the code to test LeagueV4LeagueEntryDTO
      //var instance = new RiotApi.LeagueV4LeagueEntryDTO();
      //expect(instance).to.be.a(RiotApi.LeagueV4LeagueEntryDTO);
    });
