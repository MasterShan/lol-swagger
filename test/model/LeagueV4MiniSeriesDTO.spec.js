...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RiotApi.LeagueV4MiniSeriesDTO();
  });
  ...
  describe('LeagueV4MiniSeriesDTO', function() {
    it('should create an instance of LeagueV4MiniSeriesDTO', function() {
      // uncomment below and update the code to test LeagueV4MiniSeriesDTO
      //var instance = new RiotApi.LeagueV4MiniSeriesDTO();
      //expect(instance).to.be.a(RiotApi.LeagueV4MiniSeriesDTO);
    });
