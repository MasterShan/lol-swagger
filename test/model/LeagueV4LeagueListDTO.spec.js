...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RiotApi.LeagueV4LeagueListDTO();
  });
  ...
  describe('LeagueV4LeagueListDTO', function() {
    it('should create an instance of LeagueV4LeagueListDTO', function() {
      // uncomment below and update the code to test LeagueV4LeagueListDTO
      //var instance = new RiotApi.LeagueV4LeagueListDTO();
      //expect(instance).to.be.a(RiotApi.LeagueV4LeagueListDTO);
    });
